...
def test_open_imaging_manage_masters(page: Page) -> None:
    ...
    # we wait a second to be sure we have the final page.
    time.sleep(1)
    expect(page).to_have_url("http://dev.siveo.net/mmc/main.php?module=imaging&submod=manage&action=master")
...
def test_open_imaging_manage_bootservices(page: Page) -> None:
    ...
    # we wait a second to be sure we have the final page.
    time.sleep(1)
    expect(page).to_have_url("http://dev.siveo.net/mmc/main.php?module=imaging&submod=manage&action=service")
...
def test_open_imaging_manage_bootmenu(page: Page) -> None:
    ...
    # we wait a second to be sure we have the final page.
    time.sleep(1)
    expect(page).to_have_url("http://dev.siveo.net/mmc/main.php?module=imaging&submod=manage&action=bootmenu")
...
def test_open_imaging_configuration(page: Page) -> None:
    ...
    # we wait a second to be sure we have the final page.
    time.sleep(1)
    expect(page).to_have_url("http://dev.siveo.net/mmc/main.php?module=imaging&submod=manage&action=configuration")
...
def test_open_imaging_manage_sysprep(page: Page) -> None:
    ...
    # we wait a second to be sure we have the final page.
    time.sleep(1)
    expect(page).to_have_url("http://dev.siveo.net/mmc/main.php?module=imaging&submod=manage&action=systemImageManager")
...
def test_open_imaging_manage_groups(page: Page) -> None:
    ...
    # we wait a second to be sure we have the final page.
    time.sleep(1)
    expect(page).to_have_url("http://dev.siveo.net/mmc/main.php?module=imaging&submod=manage&action=list_profiles")
...
def test_open_imaging_add_groups(page: Page) -> None:
    ...
    # we wait a second to be sure we have the final page.
    time.sleep(1)
    expect(page).to_have_url("http://dev.siveo.net/mmc/main.php?module=imaging&submod=manage&action=computersprofilecreator")
